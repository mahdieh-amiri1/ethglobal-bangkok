...
export namespace ArbitrumOneTypes {
...
export type _SubgraphErrorPolicy_ =
  ...
  export type QuerySdk = {
      /** null **/
  arbitrum_storageData: InContextSdkMethod<Query['arbitrum_storageData'], Queryarbitrum_storageDataArgs, MeshContext>,
  /** null **/
  arbitrum_storageDatas: InContextSdkMethod<Query['arbitrum_storageDatas'], Queryarbitrum_storageDatasArgs, MeshContext>,
  /** Access to subgraph metadata **/
  ...
  export type SubscriptionSdk = {
      /** null **/
  arbitrum_storageData: InContextSdkMethod<Subscription['arbitrum_storageData'], Subscriptionarbitrum_storageDataArgs, MeshContext>,
  /** null **/
  arbitrum_storageDatas: InContextSdkMethod<Subscription['arbitrum_storageDatas'], Subscriptionarbitrum_storageDatasArgs, MeshContext>,
  /** Access to subgraph metadata **/
  arbitrum__meta: InContextSdkMethod<Subscription['arbitrum__meta'], Subscriptionarbitrum__metaArgs, MeshContext>
  };

  export type Context = {
      ["arbitrum-one"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
